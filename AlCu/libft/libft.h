...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/11/07 16:53:26 by sdahan            #+#    #+#             */
/*   Updated: 2015/10/14 17:55:22 by sdahan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list				*ft_lstnfind(t_list *lst, void *data_ref, int n);
...
char				*ft_strarround(char *r, int dot, int size);
